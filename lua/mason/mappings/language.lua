...
return {
  ...
  html = { "html-lsp", "prettier", "prettierd" },
  java = { "clang-format", "jdtls" },
  javascript = { "chrome-debug-adapter", "clang-format", "curlylint", "deno", "eslint-lsp", "eslint_d", "firefox-debug-adapter", "node-debug2-adapter", "prettier", "prettierd", "quick-lint-js", "rome", "typescript-language-server" },
  ...
  perl = { "perlnavigator" },
  php = { "curlylint", "intelephense", "php-debug-adapter", "phpactor", "psalm" },
