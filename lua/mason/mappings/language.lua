...
return {
    ...
    fortran = { "fortls" },
    gitcommit = { "gitlint" },
    go = { "delve", "djlint", "go-debug-adapter", "gofumpt", "goimports", "golangci-lint", "golangci-lint-langserver",
        "golines", "gomodifytags", "gopls", "gotests", "impl", "json-to-struct", "revive", "staticcheck" },
    ...
    javascript = { "chrome-debug-adapter", "clang-format", "deno", "eslint-lsp", "eslint_d", "firefox-debug-adapter",
        "node-debug2-adapter", "prettier", "prettierd", "quick-lint-js", "rome", "typescript-language-server", "xo" },
    ...
    markdown = { "alex", "grammarly-languageserver", "ltex-ls", "markdownlint", "marksman", "prettier", "prettierd",
        "proselint", "prosemd-lsp", "remark-language-server", "textlint", "vale", "write-good", "zk" },
    ...
    python = { "autopep8", "black", "blue", "debugpy", "flake8", "isort", "jedi-language-server", "mypy", "pylint",
        "pyright", "python-lsp-server", "sourcery", "vulture", "yapf" },
    r = { "r-languageserver" },
    ...
    toml = { "taplo" },
    twig = { "curlylint" },
    typescript = { "chrome-debug-adapter", "deno", "eslint-lsp", "eslint_d", "firefox-debug-adapter",
        "node-debug2-adapter", "prettier", "prettierd", "rome", "typescript-language-server", "xo" },
    v = { "vls" },
    ...
    yaml = { "actionlint", "cfn-lint", "prettier", "prettierd", "spectral-language-server", "yaml-language-server",
        "yamllint" },
    zig = { "zls" }
}
