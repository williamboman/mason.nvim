...
return {
  ...
  python = { "autoflake", "autopep8", "black", "blue", "debugpy", "flake8", "isort", "jedi-language-server", "mypy", "pydocstyle", "pylama", "pylint", "pyproject-flake8", "pyre", "pyright", "python-lsp-server", "rstcheck", "ruff", "sourcery", "usort", "vulture", "yapf" },
  r = { "r-languageserver" },
