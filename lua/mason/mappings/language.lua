...
return {
  ...
  javascript = { "chrome-debug-adapter", "clang-format", "deno", "eslint-lsp", "eslint_d", "firefox-debug-adapter", "glint", "node-debug2-adapter", "prettier", "prettierd", "quick-lint-js", "rome", "rustywind", "semgrep", "typescript-language-server", "vtsls", "xo" },
  ...
  typescript = { "chrome-debug-adapter", "deno", "eslint-lsp", "eslint_d", "firefox-debug-adapter", "glint", "node-debug2-adapter", "prettier", "prettierd", "rome", "rustywind", "semgrep", "typescript-language-server", "vtsls", "xo" },
  v = { "vls" },
