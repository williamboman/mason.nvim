...
return {
  ...
  javascript = { "chrome-debug-adapter", "clang-format", "deno", "eslint-lsp", "eslint-mdx", "eslint_d", "firefox-debug-adapter", "glint", "js-debug-adapter", "node-debug2-adapter", "prettier", "prettierd", "quick-lint-js", "rome", "semgrep", "typescript-language-server", "xo" },
  ...
  markdown = { "alex", "cbfmt", "eslint-mdx", "grammarly-languageserver", "ltex-ls", "markdownlint", "marksman", "prettier", "prettierd", "proselint", "prosemd-lsp", "remark-cli", "remark-language-server", "textlint", "vale", "write-good", "zk" },
